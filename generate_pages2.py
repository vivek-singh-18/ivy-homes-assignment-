...
with open("frontend/src/pages/Listings.jsx", "w", encoding="utf-8") as f:
...
with open("frontend/src/pages/ListingDetail.jsx", "w", encoding="utf-8") as f:
    f.write("""import { useState, useEffect } from 'react';
...
with open("frontend/src/pages/Saved.jsx", "w", encoding="utf-8") as f:
    f.write("""import { useState, useEffect } from 'react';
...
with open("frontend/src/pages/Rentals.jsx", "w", encoding="utf-8") as f:
    f.write("""import { useState, useEffect } from 'react';
import api from '../api';
...
with open("frontend/src/pages/Projects.jsx", "w", encoding="utf-8") as f:
    f.write("""import { useState, useEffect } from 'react';
import api from '../api';
...
with open("frontend/src/pages/Insights.jsx", "w", encoding="utf-8") as f:
